...
Msbuild.exe CANStream.sln /p:Configuration=Release_OpenSource /p:Platform="Any CPU"
...
RMDIR bin\Release_OpenSource /S /Q
...
MKDIR Output\MasterOpenSouce\Bin\Release

:: Copy all installers
copy ..\Installer\Bin\Release_OpenSource\CANStream_Setup_Win32.exe Output\MasterOpenSouce\Bin\Release
copy ..\Installer\Bin\Release_OpenSource\CANStream_Setup_x64.exe Output\MasterOpenSouce\Bin\Release
...
cd..
copy "..\..\CANStream\bin\Release_OpenSource\CANStream Release notes.txt" MasterOpenSouce
