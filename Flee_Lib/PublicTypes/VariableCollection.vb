...
#Region "IDictionary Implementation"
	...
	'VB added function
	''' <include file='Resources/DocComments.xml' path='DocComments/VariableCollection/TrySetValue/*' />
	Public Function TrySetValue(ByVal key As String, ByVal value As Object) As Boolean
		Dim v As IVariable = Me.GetVariable(key, False)
		If Not v Is Nothing Then
